...
class VendorManifest(MozbuildObject):
    ...
    def vendor(
        ...
        if "patches" in self.manifest["vendoring"] and patch_mode == "only":
            ...
            self.run_verdoring_actions(revision, "post-patch-actions")
            return
    ...
    def process_regular_or_individual(
        ...
        self.run_verdoring_actions(new_revision, "update-actions")
    ...
    def run_verdoring_actions(self, revision, actions_type="update-actions"):
